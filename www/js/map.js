...
$(function() {
  var mapboxToken =
      window.APP_CONFIG && window.APP_CONFIG.MAPBOX_TOKEN
          ...
          : "";
  var mapboxStyleUrl =
      window.APP_CONFIG && window.APP_CONFIG.MAPBOX_STYLE_URL
          ? window.APP_CONFIG.MAPBOX_STYLE_URL
          : "";
  ...
  // TODO: update view location to be UIC-area
    ...
    L.tileLayer(mapboxStyleUrl + '?access_token=' + encodeURIComponent(mapboxToken), {
